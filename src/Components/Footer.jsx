  ...
  return (
    ...
    <div className="footer bg-[#f8f8f8] grid list-none lg:flex lg:h-[362px] ">
      ...
      <div className="contactUs w-[294px] mt-14 ml-[41px] lg:ml-[442px]">
        <div className="title text-[15.77px] font-[600] text-[#0E2368] mt-[42px] tracking-wide mb-2 lg:text-[18.84px]">Contact Us</div>
      ...
      <div className="more mt-14 ml-[41px] lg:mt-24 lg:ml-[102px]">
        <div className="title text-[15.77px] font-[600] text-[#0E2368] mb-4 lg:text-[18.84px]">More</div>
      ...
      <div className="copyRight text-[8.76px] w-[111px] text-[#828B9C] mx-auto mt-[30px] lg:text-[14.66px] lg:w-[197px] lg:absolute lg:bottom-[110px] lg:right-[150px] ">© 2022 Food Truck Example</div>
